...
// DiskProvisionErrors are errors threw by ecs create disk api
...
// DiskAttachDetachErrors are errors threw by disk attach
...
// DiskMountErrors are errors threw by disk mount
var DiskMountErrors = map[string]*errorInfo{}

// DiskDeleteErrors are errors threw by disk delete
var DiskDeleteErrors = map[string]*errorInfo{}

// NasFilesystemCreateErrors are errors threw by nas create
var NasFilesystemCreateErrors = map[string]*errorInfo{}

// NasFilesystemDeleteErrors are errors threw by nas filesystem delete
var NasFilesystemDeleteErrors = map[string]*errorInfo{}

// NasMountTargetCreateErrors are errors threw by nas mount target create
var NasMountTargetCreateErrors = map[string]*errorInfo{}

// NasMountTargetDeleteErrors are errors threw by nas mount target delete
